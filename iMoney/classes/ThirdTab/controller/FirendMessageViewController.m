...
@interface FirendMessageViewController ()
...
-(void)loadData{
    firendMessageData = [[BaseMessageModel alloc]init];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return firendMessageData.dataArray.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *SimpleTableIdentifier = @"FirendMessageTableViewCell";
...
{
    ArrangeModel *itemData = firendMessageData.dataArray[indexPath.row];
