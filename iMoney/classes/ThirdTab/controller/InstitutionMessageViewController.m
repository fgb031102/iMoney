//
//  InstitutionMessageViewController.m
//  IQPlatform
//
...
@interface InstitutionMessageViewController ()

@end

@implementation InstitutionMessageViewController
...
-(void)loadData{
    institutionMessageData = [[BaseMessageModel alloc]init];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return institutionMessageData.dataArray.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *SimpleTableIdentifier = @"InstitutionMessageTableViewCell";
...
{
    ArrangeModel *itemData = institutionMessageData.dataArray[indexPath.row];
