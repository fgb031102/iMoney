//
//  ProductRankingViewController.m
//  IQPlatform
//
...
#import "ProductRankingViewController.h"
#import "ProductTableViewCell.h"
#import "ShowProductViewController.h"

@interface ProductRankingViewController ()

@end

@implementation ProductRankingViewController
...
-(void)loadData{
    productData = [[ProductModel alloc]init];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return productData.dataArray.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *SimpleTableIdentifier = @"ProductPageTableViewCell";
    
    ProductTableViewCell *cell = (ProductTableViewCell *)[tableView dequeueReusableCellWithIdentifier:SimpleTableIdentifier];
    if (cell == nil) {
        cell = [DeviceCapabilityHelper loadCellFromBundle:@"ProductTableViewCell" andClass:[ProductTableViewCell class]];
...
{
    ProductModel *itemData = productData.dataArray[indexPath.row];
    ShowProductViewController *productPage = [[ShowProductViewController alloc]initWithProduct:itemData];
