//
//  InstitutionRankingViewController.m
//  IQPlatform
//
...
@interface InstitutionRankingViewController ()

@end

@implementation InstitutionRankingViewController
...
-(void)loadData{
    institutionData = [[InstitutionModel alloc]init];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return institutionData.dataArray.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *SimpleTableIdentifier = @"InstitutionPageTableViewCell";
    
    InstitutionTableViewCell *cell = (InstitutionTableViewCell *)[tableView dequeueReusableCellWithIdentifier:SimpleTableIdentifier];
    if (cell == nil) {
        cell = [DeviceCapabilityHelper loadCellFromBundle:@"InstitutionTableViewCell" andClass:[InstitutionTableViewCell class]];
