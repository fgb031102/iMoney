//
//  ArticleRankingViewController.m
//  IQPlatform
//
...
@interface ArticleRankingViewController ()

@end

@implementation ArticleRankingViewController
...
-(void)loadData{
    articleData = [[ArticleModel alloc]init];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return articleData.dataArray.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *SimpleTableIdentifier = @"ArticlePageTableViewCell";
    
    ArticleTableViewCell *cell = (ArticleTableViewCell *)[tableView dequeueReusableCellWithIdentifier:SimpleTableIdentifier];
    if (cell == nil) {
        cell = [DeviceCapabilityHelper loadCellFromBundle:@"ArticleTableViewCell" andClass:[ArticleTableViewCell class]];
...
{
    ArticleModel *itemData = articleData.dataArray[indexPath.row];
    showArticleViewController *articlePage = [[showArticleViewController alloc]initWithArticle:itemData];
