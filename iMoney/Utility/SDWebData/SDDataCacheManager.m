...
- (id)init
{
    if ((self = [super init]))
    {
        ...
        //default memCacheMaxSize 10M
        memCacheMaxSize = 10*1024*1024;
...
- (void)setMemCacheWithObject:(id)obj withKey:(id)key
{
    ...
    while ([memCacheKeyArray count]>0 && block()>memCacheMaxSize)
    {
