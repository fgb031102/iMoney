...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"下拉将开始刷新...",),
                       NSLocalizedString(@"松开吧...",),
                       NSLocalizedString(@"更新中...",),
                       nil];
        
        NSString *subtitle = [NSString stringWithFormat:@"最后更新:%@", [PublicUtility getNowMintue]];
        self.subtitles = [NSMutableArray arrayWithObjects:subtitle, subtitle, @"", @"", nil];
    ...
    if(hasCustomView) {
        ...
        switch (self.state) {
            ...
            case SVPullToRefreshStateLoading:
                ...
                NSString *subtitle = [NSString stringWithFormat:@"最后更新:%@", [PublicUtility getNowMintue]];
                self.subtitles[0] = subtitle;
                self.subtitles[1] = subtitle;
                break;
        }
