...
- (void)setPhotos:(NSArray *)photos
{
    ...
    _saveImageBtn.frame = CGRectMake(kDeviceWidth - btnWidth - 10, 0, btnWidth, btnWidth);
    _saveImageBtn.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    [_saveImageBtn setImage:[UIImage imageNamed:@"download_image"] forState:UIControlStateNormal];
    [_saveImageBtn setImage:[UIImage imageNamed:@"download_image"] forState:UIControlStateHighlighted];
    [_saveImageBtn setImage:[UIImage imageNamed:@"download_image"] forState:UIControlStateHighlighted];
